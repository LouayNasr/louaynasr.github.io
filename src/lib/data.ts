...
export const mockProjects: Project[] = [
  ...
  // },
  {
    id: "3",
    title: "GlobeX app",
    description: "Modern Jetpack Compose App that provides real-time currency exchange rates and conversion tools.",
    longDescription: "GlobeX is a modern Android application built with Jetpack Compose that provides real-time currency exchange rates and conversion tools. It leverages the latest Android technologies and follows Clean Architecture principles to ensure a robust, scalable, and maintainable codebase.",
    image: "/GlobeX.png",
    category: "Utilities",
    technologies: ["Jetpack Compose", "Retrofit", "Navigation 3", "Coil", "Hilt", "DataStore Preferences", "Kotlin Serialization", "Kotlin Coroutines"],
    githubUrl: "https://github.com/LouayNasr/GlobeX",
    featured: false,
  },
];
